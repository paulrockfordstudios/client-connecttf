...
import { btnsColorByEnergy, btnsColorBySpectrum } from "../../../Utils/misc/misc";
                            ...
                            <div className="profileConnectBtns-container">
                                <div className="profileConnectBtns">
                                    {union.spectrum === "rainbow" || union.spectrum === "platinum" ?
                                        (
                                            <>
                                                <button className={`profileDisconnectBtn ${union.spectrum}`}><MoreHoriz /></button>
                                                <button className={`profileFollowBtn ${union.spectrum}`} onClick={handleUnionFollowClick}>
                                                    {// follow button status
                                                        currentUser.unionFollowing.includes(union?._id) 
                                                            ? <><People className="profileFollowIcon" /><Check /></> 
                                                            : currentUser.unionFollowRequesting.includes(union?._id) 
                                                                ? "Requested" 
                                                                : "Befriend us!"
                                                    }
                                                </button>
                                                <button className={`profileMessageBtn ${union.spectrum}`}>Message</button>
                                                <button className={`profileSubscribeBtn ${union.spectrum}`} onClick={handleUnionSubscribeClick}>
                                                    {// subscribe btutton status
                                                        currentUser.unionSubscribing.includes(union._id) 
                                                            ? <><Mail className="profileSubscribeIcon" /><Check /></> 
                                            ...
                                            <>
                                                {union.spectrum === "diamond" ?
                                                    (
                                                        <>
                                                            <button className="profileDisconnectBtn" style={{backgroundImage: "url(/misc/diamond-btn5.jpg)", backgroundSize: "cover"}}>
                                                            ...
                                                            <button className="profileFollowBtn" style={{backgroundImage: "url(/misc/diamond-btn7.jpg)", backgroundSize: "cover"}} onClick={handleUnionFollowClick}>
                                                                {// follow button status
                                                                    currentUser.unionFollowing.includes(union?._id) ? 
                                                                        (
                                                                            <>
                                                            ...
                                                            <button className="profileMessageBtn" style={{backgroundImage: "url(/misc/diamond-btn2.jpg)", backgroundSize: "cover"}}><span className="pfbDiamondText">Message</span></button>
                                                            <button className="profileSubscribeBtn" style={{backgroundImage: "url(/misc/diamond-btn4.jpg)", backgroundSize: "cover"}}onClick={handleUnionSubscribeClick}>
                                                                {
                                                                    currentUser.unionSubscribing.includes(union?._id) ?  
                                                                        (
                                                                            <>
                                                                                ...
                                                                                <Mail className="profileSubscribeIcon" style={{ fill: "url(#gold2-gradient)"}}/>
                                                                                <svg width="0em" height="0em">
                                                                                    <linearGradient id="gold3-gradient">
                                                                                        <stop stopColor="#eed264" offset="0%" />
                                                                                        <stop stopColor="#ab781d" offset="100%" />
                                                        ...
                                                        <div className={`profileBtns ${union.spectrum}`}>
                                                            <button className="profileDisconnectBtn"><MoreHoriz /></button>
                                                            ...
                                                            <button className={`profileMessageBtn BTN_CLR ${union?.spectrum}`}>Message</button>
                                        ...
                                        <button className="profileFollowBtn" onClick={handleFlameFollowClick}>
                                            {// follow button status
                                                currentUser.flameFollowing.includes(user?._id) 
                                                    ? <><Person className="profileFollowIcon" /><Check /></> 
                                                    : currentUser.flameFollowRequesting?.includes(user?._id) 
                                                        ? "Requested"
                                                        : "Befriend me!"
                                            }
                                        </button>
                                        <button className={`profileMessageBtn BTN_CLR ${user?.energy}`}>Message</button>
